...
var domify = require('component~domify@0.1.0')
  ...
  , html = require('audio/components/audio/0.1.0/template.js')
  , Progress = require('audio/components/audio/0.1.0/progress.js');
...
function spinnerUpdate(el){
  if(this.audio.readyState == 4){
    this.el.parentElement.childNodes[1].style.visibility = "hidden"
  }
}
/**
...
Audio.prototype.toggle = function(e){
  if(this.audio.readyState != 4){
    this.el.parentElement.childNodes[1].style.visibility = "visible"
  }else{
    this.el.parentElement.childNodes[1].style.visibility = "hidden"
  }
  console.log(this);
...
Audio.prototype.play = function(){
  audioArr.forEach(function(item){
    item.pause();
  });
  console.log(this);
  this.audio.play();
...
require.register("audio/components/audio/0.1.0/progress.js", function (exports, module) {
...
Progress.prototype.draw = function(ctx){
  ...
  ctx.lineWidth = 6;
  ctx.beginPath();
  ctx.arc(x, y, rad-2, 0, angle, false);
  ctx.stroke();
...
require.register("audio/components/audio/0.1.0/template.js", function (exports, module) {
